...
public interface IGMBLDataDao {
	...
	public static final String RCL_IGM_UNFETCHED_SAVE_BL = "RCL_IGM_BL_INFO.RCL_IGM_GET_MASTER_UNFETCHED_BL_DATA";
	...
	public void saveBLData(List<ImportGeneralManifestMod> blsForSavingCont,String procedureName,String fetchedinsertBL) throws Exception;
