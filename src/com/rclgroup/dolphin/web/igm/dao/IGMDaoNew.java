 ...
 */
public interface IGMDaoNew {

	/** The Constant SQL_GET_IGM_DATA. */
	public static final String SQL_GET_IGM_DATA = "RCL_IGM_INFO_NEW.RCL_IGM_GET_DATA";
	/** The Constant SQL_GET_IGM_DATA. */
	public static final String SQL_GET_SAVED_IGM_VESSLE_VOYAGE_DATA = "RCL_IGM_VESEEL_VOYOAGE_INFO.RCL_IGM_GET_SAVED_VESEEL_VOYOGE_DATA";
	
	public static final String SQL_GET_IGM_BL_MSTR_DATA_EXPORT = "RCL_IGM_BL_INFO_EXPORT.RCL_IGM_GET_MASTER_BL_DATA";
	/** The Constant SQL_GET_IGM_DATA. */
	public static final String SQL_GET_IGM_BL_MSTR_DATA = "RCL_IGM_BL_INFO.RCL_IGM_GET_MASTER_BL_DATA";// janmejaya
	
	public static final String SQL_GET_IGM_BL_MSTR_DATA_NEW = "RCL_IGM_BL_INFO.RCL_IGM_GET_MASTER_BL_DATA_NEW";// janmejaya
	
	public static final String SQL_GET_IGM_BL_MSTR_DATA_EXPORT_NEW = "RCL_IGM_BL_INFO_EXPORT.RCL_IGM_GET_MASTER_BL_DATA_NEW";// janmejaya
	
	public static final String SQL_GET_IGM_BL_MASTER_SAVE_DATA = "RCL_IGM_BL_INFO.RCL_IGM_GET_BL_DATA_MASTER_SAVE_DATA";// janmejaya
	...
	public static final String SQL_GET_IGM_BL_SAVE_DATA_NEW = "RCL_IGM_BL_INFO.RCL_IGM_GET_SAVE_BL_DATA_NEW";// janmejaya
	
	public static final String SQL_GET_IGM_BL_SAVE_DATA_EXPORT_NEW = "RCL_IGM_BL_INFO_EXPORT.RCL_IGM_GET_SAVE_BL_DATA_NEW";// janmejaya
	/** The Constant SQL_GET_IGM_DATA. */
	//public static final String SQL_GET_IGM_VESSLE_VOYAGE_DATA = "RCL_IGM_INFO_NEW.RCL_IGM_VESSLE_VOYAGE_GET_DATA";//RCL_IGM_VESSLE_VOYAGE_GET_MASTER_DATA
	public static final String SQL_GET_IGM_VESSLE_VOYAGE_DATA = "RCL_IGM_VESEEL_VOYOAGE_INFO.RCL_IGM_VESSLE_VOYAGE_GET_MASTER_DATA";//
	...
	public static final String SQL_EXTRA =  "RCL_IGM_FILE_INFO.RCL_IGM_ACK_FILE";
	
	public static final String SQL_STOWAGE_IMPORT=  "RCL_IGM_FILE_INFO.RCL_IGM_STOWAGE_IMPORT";
	...
	public static final String KEY_IGM_CONTAINER_NUM= "P_I_V_CONTAINER_NUM";
	...
	/**
	 * The Constant
	 * KEY_IGM_TOTAL_NO_OF_TRANSPORT_EQUIPMENT_REPORTED_ON_ARRIVAL_DEPARTURE.
	 */
	 ...
	 * @throws DataAccessException the data access exception
	 */
	public Map getVesselVoyagData(Map amapParam , String procdureName) throws BusinessException, DataAccessException;
	...
	/**
	 * Save ContanorDtls. Pass Container Dtl string
	 * 
	 * @throws BusinessException   the business exception
	 * @throws DataAccessException the data access exception
	 */
	...
	public Map<Object, Object> getStowageExport(Map<String, String> mapParam, String procedureName)throws BusinessException, DataAccessException;
	
	public Map<Object, Object> getBLCarogoDetails(Map<String, String> mapParam, String procedureName) throws BusinessException;
