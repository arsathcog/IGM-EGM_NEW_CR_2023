 ...
 */
public class ImportGeneralManifestResultSetSCE {
	 ...
	 */
	public ImportGeneralManifestResultSetSCE() {
		super();
	}
	 ...
	 * @param bLS      the b LS
	 */
	public ImportGeneralManifestResultSetSCE(ImportGeneralManifestMod service, int sequence,
