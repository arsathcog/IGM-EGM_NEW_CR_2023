...
//		}
	...
	/*
	 * public String getCntrAgntCd() { return cntrAgntCd; }
	 * 
	 * public void setCntrAgntCd(String cntrAgntCd) { cntrAgntCd =
	 * FiledValidation.isNullAndSetlength(cntrAgntCd, 1); this.cntrAgntCd =
	 * cntrAgntCd; }
	 * 
	 * // This value is come from BL Json object "containerWeight" (Use from EZDL.)
	 * public String getCntrWeight() { return cntrWeight; }
	 * 
	 * public void setCntrWeight(String cntrWeight) { this.cntrWeight = cntrWeight;
	 * }
	 * 
	 * // This value is come from BL Json object "totalNumberOfPackagesInContainer"
	 * // (Packages in Container from IGM container section. ) public String
	 * getTotalNmbrOfPkgs() { return totalNmbrOfPkgs; }
	 * 
	 * public void setTotalNmbrOfPkgs(String totalNmbrOfPkgs) { this.totalNmbrOfPkgs
	 * = totalNmbrOfPkgs; }
	 */
