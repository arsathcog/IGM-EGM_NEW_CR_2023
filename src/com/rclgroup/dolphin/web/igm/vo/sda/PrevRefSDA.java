...
//		private String csnSiteId;
		...
		// This value is come from BL Json object "First Port of Entry/Last Port of
		// Departure"
		...
		// Same as CFS-Custom Code from current screen for LC movement . In case of TI,
		// CFS-Custom Code will be blank. In such case destination port will same as DEL
		// of BL.
