...
public class TrnsprtDocSDA {
	private String prtOfAcptCdd;
	private String prtOfAcptName;
	private String prtOfReceiptCdd;
	private String prtOfReceiptName;
	private String cnsgnrsName;
	private String cnsgnrsCd;
	private String cnsgnrCdTyp;
	...
	// This value is come from BL Json object "Port of Acceptance" (Add new field BL
		// POL in BL section)
		...
		// This value is come from BL Json object "Port of Acceptance Name"(Take from
		// port master setup while generating json file)
		...
		// This value is come from BL Json object "porTrept" Add new field DEL which
		// will come from BL DEL. . make it
		...
		// This value is come from BL Json object "Consignor?s Name"(Shipper name based
		// on shipper code from BL. Add this new field )
		...
		// This value is come from BL Json object "Consignor Street Address" (Add new
		// column.Value will come from shipper. Same as consignee in current IGM)
		...
		// (This value is come from BL Json object) (Add new column. Value will come
		// from shipper. )
		...
		// This value is come from BL Json object "Consignor country sub division name"
		...
		// This value is come from BL Json object "Consignor Country Code" (Add new
		// column. Value will come from shipper. )
		...
		// This value is come from BL Json object "customerName"(Already in current IGM
		// screen)
		...
		// This value is come from BL Json object "customerCode"(Already in current IGM
		// screen)
		...
		// This value is come from BL Json object "countryCode" (Already in current IGM
		// screen) mandatory.
		...
		// This value is come from BL Json object "notifyPartyDlts" (Already in current
		// IGM screen) mandatory.
		...
		// (Take from customer master on the basis of notify party. During generating
		// JSON file)
		...
		// optional (The Type ofIdentification of Code of the Notified Party as per the
		// Transport Document issued by MLO.)
		...
		// optional > This value is come from BL Json object "countryCode" optional
		// (Already in current IGM screen)
		...
		// (Use marks description from IGM screen. Just pickup first 512 character
		// while) >mandatory
		...
		// optional > This value is come from BL Json object "UCR Typel" (Add new field
		// Free text in BL )
		...
		// optional >This value is come from BL Json object "UCR Code" (Add new field
		// Free text in BL )
