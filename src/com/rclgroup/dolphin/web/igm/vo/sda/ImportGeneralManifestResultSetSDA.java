...
/**
 * The Class ImportGeneralManifestResultSetSDA.
 */
public class ImportGeneralManifestResultSetSDA {
	 ...
	 */
	public ImportGeneralManifestResultSetSDA() {
		super();
	}
	 ...
	 * @param bLS      the b LS
	 */
	public ImportGeneralManifestResultSetSDA(ImportGeneralManifestMod service, int sequence,
