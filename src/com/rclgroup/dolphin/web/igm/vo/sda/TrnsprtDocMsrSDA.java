...
public class TrnsprtDocMsrSDA {
	...
	// This value is come from BL Json object "Number of Packages" (Same like above.
	// Details in 3.5.6.3 MC Location_Customs)
	...
	// This value is come from BL Json object "Type of Package" (Same like above.
	// Details in 3.5.6.3 MC Location_Customs)
	...
	// "marksNumberDtlstls" (Use Marks & Numbers from IGM screen. First 512
	...
	// This value is come from BL Json object "GrossWeightVessel" , "Gross Cargo
	// Weight BL level" (Use Gross Cargo Weight of BL while generating json file)
	...
	// This value is come from BL Json object "NetWeightVessel" (Use general tab Net
	// Cargo Weight of BL while generating JSON file)>optional
	...
	// (Use System Parameters Maintenance under DocumentationUnit of Measurement)
	// >optional
