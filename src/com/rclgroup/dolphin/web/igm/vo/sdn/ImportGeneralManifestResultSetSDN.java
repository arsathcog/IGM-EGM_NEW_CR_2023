 ...
 */
public class ImportGeneralManifestResultSetSDN {
	 ...
	 */
	public ImportGeneralManifestResultSetSDN() {
		super();
	}
	 ...
	 * @param bLS      the b LS
	 */
	public ImportGeneralManifestResultSetSDN(ImportGeneralManifestMod service, int sequence,
