...
public class VoyageDtlsSDN {
	...
	private List<ShipItnrySDN> shipItnry;

	public List<ShipItnrySDN> getShipItnry() {
		return shipItnry;
	}

	public void setShipItnry(List<ShipItnrySDN> shipItnry2) {
