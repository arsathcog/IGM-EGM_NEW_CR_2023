...
public class CrewEfctSAA {
	...
	public String getCrewEfctQntyOnbrdCd() {
		return crewEfctQntyOnbrdCd;
	}
	public void setCrewEfctQntyOnbrdCd(String crewEfctQntyOnbrdCd) {
		this.crewEfctQntyOnbrdCd = crewEfctQntyOnbrdCd;
	}
