...
public class VoyageDtlsSAA {
	...
	private List<ShipItnrySAA> shipItnry;

	public List<ShipItnrySAA> getShipItnry() {
		return shipItnry;
	}

	public void setShipItnry(List<ShipItnrySAA> shipItnry2) {
