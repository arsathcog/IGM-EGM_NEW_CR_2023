 ...
 */
public class ImportGeneralManifestResultSetSAA {
	 ...
	 */
	public ImportGeneralManifestResultSetSAA() {
		super();
	}
	 ...
	 * @param bLS      the b LS
	 */
	public ImportGeneralManifestResultSetSAA(ImportGeneralManifestMod service, int sequence,
