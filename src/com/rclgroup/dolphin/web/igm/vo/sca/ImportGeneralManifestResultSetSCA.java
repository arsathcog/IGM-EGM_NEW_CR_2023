 ...
 */
public class ImportGeneralManifestResultSetSCA {
	 ...
	 */
	public ImportGeneralManifestResultSetSCA() {
		super();
	}
	 ...
	 * @param bLS      the b LS
	 */
	public ImportGeneralManifestResultSetSCA(ImportGeneralManifestMod service, int sequence,
