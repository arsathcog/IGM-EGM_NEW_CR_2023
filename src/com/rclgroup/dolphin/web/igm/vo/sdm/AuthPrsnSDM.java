...
//		shpngLineCd = FiledValidation.isNullAndSetlength(shpngLineCd, 10);
   ...
   //The value of  "MasterName" current screen
	...
	public String toString() {
		return "AuthPrsnSDM [sbmtrTyp=" + sbmtrTyp + ", sbmtrCd=" + sbmtrCd + ", authReprsntvCd=" + authReprsntvCd
				+ ", shpngLineCd=" + shpngLineCd + ", authSeaCarrierCd=" + authSeaCarrierCd + ", masterName="
				+ masterName + ", shpngLineBondNmbr=" + shpngLineBondNmbr + ", trmnlOprtrCd=" + trmnlOprtrCd + "]";
	}
}
