...
/**
 * The Class ImportGeneralManifestResultSetSDM.
 */
public class ImportGeneralManifestResultSetSDM {
	 ...
	 */
	public ImportGeneralManifestResultSetSDM() {
		super();
	}
	 ...
	 * @param bLS      the b LS
	 */
	public ImportGeneralManifestResultSetSDM(ImportGeneralManifestMod service, int sequence,
