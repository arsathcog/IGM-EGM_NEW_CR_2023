...
//	}
//	public String getInfoMsr() {
//		return infoMsr;
//	}
//	public void setInfoMsr(String infoMsr) {
//		this.infoMsr = infoMsr;
//	}
//	public String getInfoDt() {
//		return infoDt;
//	}
//	public void setInfoDt(String infoDt) {
//		this.infoDt = infoDt;
//	}
//	
//	
...
//		return "TmAdtnlDecSDM [tagRef=" + tagRef + ", refSerialNo=" + refSerialNo + ", infoTyp=" + infoTyp
//				+ ", infoQualifier=" + infoQualifier + ", infoCd=" + infoCd + ", infoText=" + infoText + ", infoMsr="
//				+ infoMsr + ", infoDt=" + infoDt + "]";
//	}
//	
//	
