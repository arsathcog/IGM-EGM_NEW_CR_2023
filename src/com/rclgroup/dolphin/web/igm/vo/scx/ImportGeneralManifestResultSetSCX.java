 ...
 */
public class ImportGeneralManifestResultSetSCX {
	 ...
	 */
	public ImportGeneralManifestResultSetSCX() {
		super();
	}
	 ...
	 * @param bLS      the b LS
	 */
	public ImportGeneralManifestResultSetSCX(ImportGeneralManifestMod service, int sequence,
