...
public class VoyageDtlsSEI {
	...
	private List<ShipItnrySEI> shipItnry;

	public List<ShipItnrySEI> getShipItnry() {
		return shipItnry;
	}

	public void setShipItnry(List<ShipItnrySEI> shipItnry2) {
