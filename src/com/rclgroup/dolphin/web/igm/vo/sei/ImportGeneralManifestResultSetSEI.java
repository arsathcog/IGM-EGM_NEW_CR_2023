 ...
 */
public class ImportGeneralManifestResultSetSEI {
	 ...
	 */
	public ImportGeneralManifestResultSetSEI() {
		super();
	}
	 ...
	 * @param bLS      the b LS
	 */
	public ImportGeneralManifestResultSetSEI(ImportGeneralManifestMod service, int sequence,
