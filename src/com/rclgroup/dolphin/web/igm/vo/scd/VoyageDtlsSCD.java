...
public class VoyageDtlsSCD {
	...
	private String amendment;
  	...
  	private List<ShipItnrySCD> shipItnry;


	public List<ShipItnrySCD> getShipItnry() {
		return shipItnry;
	}

	public void setShipItnry(List<ShipItnrySCD> shipItnry) {
