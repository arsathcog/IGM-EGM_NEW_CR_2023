 ...
 */
public class ImportGeneralManifestResultSetSAM {
	 ...
	 */
	public ImportGeneralManifestResultSetSAM() {
		super();
	}
	 ...
	 * @param bLS      the b LS
	 */
	public ImportGeneralManifestResultSetSAM(ImportGeneralManifestMod service, int sequence,
