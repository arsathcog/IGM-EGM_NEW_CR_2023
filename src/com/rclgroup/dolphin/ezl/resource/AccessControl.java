...
public class AccessControl extends org.apache.struts.action.ActionServlet implements GlobalConstants {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			Debug.logFramework(
					"Access Control-" + req.getLocalName() + COLON + req.getLocalPort() + COMMA + req.getPathInfo());
			...
			if (lstrScreenId.equalsIgnoreCase("SETW001")) {
			...
			/*
			 * if (account == null) { Debug.logFramework("UAB is NUll Close me");
			 * getServletConfig().getServletContext().getRequestDispatcher(NO_SESSION_PATH).
			 * forward(req, resp); return; }
			 */

			if (lstrPathInfo.equals(HOME) || lstrPathInfo.equals(REPORT_URL) || lstrPathInfo.equals(SCREEN_ID)
					...
					|| lstrScreenId != null && lstrScreenId.equalsIgnoreCase("GETBLDA")
					|| lstrScreenId != null && lstrScreenId.equalsIgnoreCase("/VesselVoyagSave")
					|| lstrScreenId != null && lstrScreenId.equalsIgnoreCase("/download")
					|| lstrScreenId != null && lstrScreenId.equalsIgnoreCase("sigm001searchNew")
					|| lstrScreenId != null && lstrScreenId.equalsIgnoreCase("sigm001Export")
					|| lstrScreenId != null && lstrScreenId.equalsIgnoreCase("csvFilePrsnOnBord")
					|| lstrScreenId != null && lstrScreenId.equalsIgnoreCase("deleteCsvFile")
					|| lstrScreenId != null && lstrScreenId.equalsIgnoreCase("applySave")
					) {
				...
				/* Do authorization check sushil commited the code */
